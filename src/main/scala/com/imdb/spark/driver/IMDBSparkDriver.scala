...
object IMDBSparkDriver extends App {

  System.setProperty("hadoop.home.dir", "C://Users//abhinachakraborty//Downloads//Install//winutils");
  ...
  val spark = SparkCommonConfig.initSparkSession("local[2]", "IMDB_Spark_Analysis")

  try {

    //set the path for input files
    val basePath = "C://Users//abhinachakraborty//Downloads//Dataset"
